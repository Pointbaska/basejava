...
<%@ page import="ru.javawebinar.basejava.model.OrganizationListSection" %>
            ...
            <c:choose>
                ...
                <c:when test="${type=='QUALIFICATIONS' || type=='ACHIEVEMENT'}">
                    <textarea name='${type}' cols=75
                              rows=5><%=String.join("\n", ((ListSection) section).getListText())%></textarea>
                </c:when>
                    ...
                    <c:forEach var="org" items="<%=((OrganizationListSection) section).getOrganizationList()%>"
                        ...
                        <div style="margin-left: 30px">
                            <c:forEach var="pos" items="${org.experienceList}">
                                <jsp:useBean id="pos" type="ru.javawebinar.basejava.model.Organization.Experience"/>
                                <dl>
